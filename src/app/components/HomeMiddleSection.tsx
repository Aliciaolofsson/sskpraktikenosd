          ...
          <Reveal>
            <div className='flex flex-col items-center'>
              ...
              <p className='mt-4'>
                ...
                behandlar både långvariga och akuta smärtor som t.ex besvär i
                rygg och nacke, stukningar, idrottsskador, hälsporre och
                tinnitus. Hudproblem kan vara svårläkta sår, acne, rosacea och
                herpes.
              </p>
              <p className='mt-5'>
                Low Level Laser Therapy (LLLT) är ett ofarligt och ytterst rent
                laserljus som stimulerar skadade celler till nybildning i
                muskler, senor och ligament. Ljuset ökar cirkulationen och
                stärker immunförsvaret. Behandlingen minskar smärta, reducerar
                inflammation och främjar läkning.
              </p>
              <h2 className='mt-5'>
                I rådande läge efter Corona pandemin är verksamheten fortfarande
                anpassad så våra kunder ej möts i väntrummet. Gott om tid före
